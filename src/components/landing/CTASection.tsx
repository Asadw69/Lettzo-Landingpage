  ...
  return <section className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-satoshi text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Ready to Stop Doing{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={onOpenModal} className="shadow-button hover:shadow-lg transition-all duration-300 hover:scale-105 text-base px-10 py-6">
              Get Started Now
