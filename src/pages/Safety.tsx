          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-[15px] text-foreground/75 font-medium pt-1">
              <li className="flex items-start gap-2.5">
                ...
                <span><strong className="font-semibold text-foreground">Always meet in public:</strong> Choose busy coffee shops, parks, cafes, sports clubs, or public venues for first-time meetups.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                <span><strong className="font-semibold text-foreground">Inform a friend:</strong> Let a friend or family member know where you are going and who you are meeting.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                <span><strong className="font-semibold text-foreground">Arrange your own transport:</strong> Arrive and leave using your own vehicle or public transit.</span>
              </li>
            </ul>
          </section>
